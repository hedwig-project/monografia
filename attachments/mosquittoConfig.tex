...
Os passos abaixo com o firewall são manuais. Eles estão concentrados em um script, que deve ser rodado após o cadastro de um nova casa (necessário alterar o contador do script).
...
Para cadastrar novo módulo, primeiro desativar o firewall:
