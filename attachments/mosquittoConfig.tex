...
Para a demonstração da implementação, foram configuradas instâncias independentes do MQTT Mosquitto Broker, em um servidor virtual. Este apêndice documenta as configurações disponíveis para conexão com tais instâncias.
Os passos abaixo com o \emph{firewall} são manuais. Eles estão concentrados em um script, que deve ser executado após o cadastro de um nova casa (necessário alterar o contador do script).
