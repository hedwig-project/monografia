\chapter{Arquitetura: Tecnologia - Aprendizado de máquina}
	...
	\section{Aprendizado de máquina no projeto Hedwig}
		...
		% TODO relacionar com o negocio falado no capitulo de analise de dados de que agendamento de luz no corredor nao significou parcela tao grande assim do uso, ou seja, precisa ser bolado jeito mais inteligente de prever quando iriam querer acender a luz
	...
	\section{Implementação}
		...
		\subsection{Tratamento de dados}
			...
			% TODO colocar referencias e falar qual tecnica foi utilizada
...
% pra que q é o quadratico?

% site do sklearn tem graficos e explicacoes dos algoritmos
		...
		% se possivel, graficos de erros e/ou falsos positivos


		\subsection{Otimização dos modelos}

% citar que conforme fosse sendo usado o sistema iria aprendendo cada vez mais (da pra revisitar frase do comeco tb)

% shift + tab + tab no jup nb --> help
% checar data.describe em um pd DF
% ver se tem algo a falar sobre bias variance trade off ou cross validation sets


% possivelmente fazer boxplots relacionando sims e naos (ver pg 129 islr)
