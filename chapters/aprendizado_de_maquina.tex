\chapter{Aprendizado de máquina}
	...
	\section{Implementação}
		...
		\subsection{Tratamento de dados}
			...
			Outra questão a ser levada em analisada é a presença de uma disparidade entre a quantidade de amostras de treino que estão em uma classificação, em relação à quantidade que está em outra. Esse evento é conhecido como oversamplig/undersampling . No caso em análise, existem muito mais dados nos quais não ocorreu ativação do relé pelo usuário (71) do que os que ocorreram (6851). Ou seja, aproximadamente 99\% dos dados estão em uma classificação, e apenas 1\% na outra.
			% TODO ver se é over ou under
