...
É um protocolo da camada de aplicação compatível com HTTP: a transição entre esses dois protocolos é feita por meio de um \textit{handshake} que usa o cabeçalho de \texttt{HTTP Upgrade}, como observado na Figura \ref{websocketVsPolling}.
